...
class Auth:
    ...
    def verify_password(self, plain_password, hashed_password):
        ...
        :param plain_password: Check the password that was entered by the user
        :param hashed_password: Check if the password provided by the user matches with the hashed password stored in database
    ...
    async def create_refresh_token(
        ...
        :param data: dict: Pass the data that will be encoded into the refresh token
        :param expires_delta: Optional[float]: Specify the number of seconds until the token expires
        :return: A refresh token that is encoded with the jwt algorithm
        :doc-author: Trelent
        """
        to_encode = data.copy()
        if expires_delta:
    ...
    async def get_current_user(
        ...
        :return: The user object, which is a user class
        :doc-author: Trelent
        """
