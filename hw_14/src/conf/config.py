...
class Settings(BaseSettings):
    DB_URL: str = "postgresql+asyncpg://postgres:password@localhost:5432/rest_app"
    ...
    CLD_NAME: str = "dpxeehnwc"
    CLD_API_KEY: int = 969879998212818
    CLD_API_SECRET: str = "9JcY1sGYdktLK-3TJQCwLGobso8"
